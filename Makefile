all: main acte1 acte2 acte3 acte3b acte4 tests-appolab


CC=clang
CFLAGS=-g -Wall -Wextra -Werror -Wno-unused-parameter

tests-appolab.o: tests-appolab.c listes.h arbres.h arbresphylo.h common_tests.h
...
acte4: acte4.o $(OBJS)
tests-appolab: tests-appolab.o $(OBJS)
